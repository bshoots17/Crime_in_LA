...
# setting a layout for a 2x3 grid, margins adjusted to fit the plots, oma() for outer margin area.
par(mfrow = c(2, 3), mar = c(1, 1, 1, 6), oma = c(0, 0, 3, 0), cex.main = 1.5)
...
mtext("Median Household Income by Year and Zip Code in LA", outer = TRUE, cex = 1.5, font = 2)
```
