...
zcta_no_NAs <- zcta_with_data %>% filter(!is.na(S1903_C03_001E))

plot(st_geometry(zcta_with_data), 
     col = brewer.pal(9, "Blues")[as.numeric(cut(zcta_with_data$S1903_C03_001E, 
                                                 breaks = 9))], 
     border = 'grey', 
     axes = TRUE, 
     main = "Median Household Income by Year and Zip Code", 
     cex.main = 1.5)
```
