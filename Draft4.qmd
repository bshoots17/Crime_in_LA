...
```{r DATA, output=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
library(sf) # for map
...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.align="center", fig.cap="Crime densities in Los Angeles by LAPD Division, 2010-2019 and 2020-Present"}
