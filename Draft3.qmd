...
la_shape <- read_sf(dsn = "0_Data/Raw_Data/Cities_and_Communities", layer = "Cities_and_Communities")

la_shape <- st_transform(la_shape, crs = 4326)  
...
plot(la_shape$geometry, lwd=.5, add=TRUE)
...
linear_model1 <- lm(HomicideCount ~ LAT_rounded + LON_rounded, data = homicides_by_year_lat_long)
